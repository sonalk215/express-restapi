...
const MONGODB_URI = 'mongodb+srv://rebelthyworld:a5a44k6QPmTxd6h6@cluster0.mq49lnp.mongodb.net/messagesDb?retryWrites=true&w=majority&appName=Cluster0';
...
.then(result => {
  ...
  app.listen(8080);  //gives a http server
})
